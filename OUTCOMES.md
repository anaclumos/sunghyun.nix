...
| b | Hyper + arrows/1-4/Enter = tiling (left/right/top/bottom, fourths, fullscreen); Hyper+C center, Hyper+V top-left | same | karabiner.json manipulators present; tile actions pass verify |
